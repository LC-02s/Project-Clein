...
export const ProjectEntity = new Entity({
  'it-moji': createProjectData({
    ...
    period: '2025.01 ~ 운영 중',
    thumbnail: {
      src: '/docs/projects/it-moji/assets/intro.png',
  ...
  attraction: createProjectData({
    ...
    thumbnail: {
      src: '/docs/projects/attraction/assets/intro-default.jpg',
  ...
  'pbl-notes': createProjectData({
    ...
    thumbnail: { src: '/docs/projects/pbl-notes/assets/intro.jpg', alt: 'PBL Notes' },
  ...
  'eung-cham-jal': createProjectData({
    ...
    thumbnail: { src: '/docs/projects/eung-cham-jal/assets/intro.png', alt: '응원 참 잘하는 집' },
  ...
  'synergy-meet-2024': createProjectData({
    ...
    thumbnail: {
      src: '/docs/projects/synergy-meet-2024/assets/intro.jpg',
