...
export const PostEntity = new Entity({
  ...
  'improve-scroll-parallax-performance': {
  ...
  'attraction-service-failure-review': {
    title: '어트랙션 서비스 운영 실패 회고',
    description:
      '뉴스레터 통합 관리 서비스 어트랙션을 구축 및 운영하며 저질렀던 기술적인 실수들을 되돌아보는 글이에요',
    thumbnail: {
      src: '/docs/projects/attraction/assets/intro-dropped.jpg',
