...
- 선언적으로 UI를 개발할 수 있고, 반복되는 UI들을 컴포넌트로 만들어 재사용하기 쉽다는 이점이 있어 도입하였습니다.
...
- 구축한 SSG 빌드 파이프라인 관련 글은 [여기](/blog/2024-11-16)에서 볼 수 있습니다.
...
- Scroll Linked Animation 기법을 쉽게 구현하기 위해 도입하였습니다.
