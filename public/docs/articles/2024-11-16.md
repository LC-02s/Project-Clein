...
또한 당시에는 좋지 않은 방법으로 `TailWindCSS`를 사용했었기에 `TailWindCSS`의 개발 경험이 좋지 않았던 상태였어서, 익숙했던 `SCSS` 문법과 `SSR` 환경설정이 편한 데다 인라인 스타일 방식 활용할 수 있는 `Emotion`으로 선택하게 되었습니다.
...
<img src="/public/images/content/2024-11-16__build-result-1.jpg" alt="SSG 빌드 결과 1" width="1458" height="795" />

<br />

<img src="/public/images/content/2024-11-16__build-result-2.jpg" alt="SSG 빌드 결과 2" width="1467" height="692" />
