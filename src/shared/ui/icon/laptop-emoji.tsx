...
export const LaptopEmoji: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#9aaab4"
      d="m.008 34.075l.006.057l.17.692A2 2 0 0 0 2 36h32a2 2 0 0 0 1.992-1.925z"
    />
    <path
      fill="#5dadec"
    ...
    <path
      fill="#9aaab4"
      d="M22.375 33.113h-7.781c-.375 0-.538-.343-.484-.675c.054-.331.359-1.793.383-1.963c.023-.171.274-.375.524-.375h7.015c.297 0 .49.163.55.489c.059.327.302 1.641.321 1.941s-.169.583-.528.583"
    />
  </svg>
)
